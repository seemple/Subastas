									...
									container.find('.tp-caption video').each(function(i) {
										try{
												if (jQuery(this).hasClass('video-js') && addedvid==0) {
													...
													if (loadit) {
														before.parentNode.insertBefore(f, before);
														jQuery('head').append('<link rel="stylesheet" type="text/css" href="../../../../../assets/plugins/revolution-slider/js/'+opt.videoJsPath+'video-js.min.css" media="screen" />');
		...
		********************************/
		...
		function createThumbs(container,opt) {
			...
			container.find('>ul:first >li').each(function(i) {
							...
							bullets.append('<div class="bullet thumb" style="background-color:'+bgcolor+';position:relative;width:'+opt.thumbWidth+'px;height:'+opt.thumbHeight+'px;background-image:url('../../../../../assets/plugins/revolution-slider/js/+src+') !important;background-size:cover;background-position:center center;"></div>');
		...
		function prepareSlides(container,opt) {
			...
			container.find('>ul:first >li').each(function(j) {
				...
				if (li.data('link')!=undefined) {
					...
					if (link=="slide") {
						...
						linktoslide="no";
						li.append('<div class="tp-caption sft slidelink" style="width:100%;height:100%;z-index:'+zindex+';" data-x="0" data-y="0" data-linktoslide="'+linktoslide+'" data-start="0"><a style="width:100%;height:100%;display:block" target="'+target+'" href="../../../../../assets/plugins/revolution-slider/js/'+link+'"><span style="width:100%;height:100%;display:block"></span></a></div>');
					}
			...
			container.find('>ul:first >li >img').each(function(j) {
				...
				if (isIE(8)) {
					...
					pari.find('.tp-bgimg').append('<img class="ieeightfallbackimage defaultimg" src="../../../../../assets/plugins/revolution-slider/js/'+src+'" style="width:100%">');
				}
			   ...
			   if (isIE(8)) {
				...
				if (vorh == "horizontal") {
					...
					for (var i=0;i<opt.slots;i++) {
							...
							if (isIE(8)) {
							   sh.find('.slot ').last().find('.slotslide').append('<img class="ieeightfallbackimage" src="../../../../../assets/plugins/revolution-slider/js/'+imgsrc+'" style="width:100%">');
				...
				for (var j=0;j<opt.slots;j++) {
					...
					for (var i=0;i<opt.slots;i++) 	{
						...
						if (isIE(8)) {
							...
							sh.find('.slot ').last().find('.slotslide').append('<img src="../../../../../assets/plugins/revolution-slider/js/'+imgsrc+'">');
							ieimgposition(sh,opt);
						}
