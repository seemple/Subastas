...
<head>
		...
		<title>Alberto Bieule - Panel de Control</title>
		...
		<link rel="stylesheet" href="<? echo base_url();?>assets/css/ace-skins.min.css" />
		...
		<script src="<? echo base_url();?>assets/js/ace-extra.min.js"></script>
		<link rel="stylesheet" href="<? echo base_url();?>assets/css/jquery-ui-1.10.3.custom.min.css" />
		<link rel="stylesheet" href="<? echo base_url();?>assets/css/jquery.gritter.css" />
		<script src="<? echo base_url();?>assets/js/jquery.gritter.min.js"></script>
		<script src="<? echo base_url();?>assets/js/jquery.validate.js" type="text/javascript"></script>
		<script src="<? echo base_url();?>assets/js/custom.js" type="text/javascript"></script>
		<link rel="stylesheet" href="<? echo base_url();?>assets/css/colorbox.css" />
		<script src="<? echo base_url();?>assets/js/jquery.colorbox-min.js"></script>
